class TowersOfHanoi {
  ...
  initGame() {
    ...
    this.drawTowers();
    this.displayMessage(
      'Move all the discs from the left tower to the right, one at a time, forming back the tower as you found it. A disc cannot be on top of a smaller disc. Have fun!'
    );
  }
